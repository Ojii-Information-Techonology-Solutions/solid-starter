...
export function IconDashboard(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M4 13h6v8h-6z" />
      <path d="M14 9h6v12h-6z" />
      <path d="M4 3h6v8h-6z" />
      <path d="M14 3h6v4h-6z" />
    </Icon>
  )
}
...
export function IconTicket(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M9 12a3 3 0 0 0 0 6a3 3 0 0 1 0 6h6a3 3 0 0 0 0 -6a3 3 0 0 1 0 -6z" />
      <path d="M21 7v-4a2 2 0 0 0 -2 -2h-14a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2a2 2 0 0 1 0 4a2 2 0 0 0 -2 2v4a2 2 0 0 0 2 2h14a2 2 0 0 0 2 -2v-4a2 2 0 0 0 -2 -2a2 2 0 0 1 0 -4a2 2 0 0 0 2 -2z" />
    </Icon>
  )
}
...
export function IconDatabase(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M4 5c0 1.657 4 3 8 3s8 -1.343 8 -3s-4 -3 -8 -3s-8 1.343 -8 3z" />
      <path d="M4 12c0 1.657 4 3 8 3s8 -1.343 8 -3" />
      <path d="M4 19c0 1.657 4 3 8 3s8 -1.343 8 -3" />
      <path d="M4 5v14" />
      <path d="M20 5v14" />
    </Icon>
  )
...
export function IconZap(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 2l-7 12h5v8l7 -12h-5z" />
    </Icon>
  )
}
...
export function IconComponents(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M4 7a2 2 0 0 1 2 -2h3a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-3a2 2 0 0 1 -2 -2z" />
      <path d="M4 14a2 2 0 0 1 2 -2h3a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-3a2 2 0 0 1 -2 -2z" />
      <path d="M13 7a2 2 0 0 1 2 -2h3a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-3a2 2 0 0 1 -2 -2z" />
      <path d="M13 14a2 2 0 0 1 2 -2h3a2 2 0 0 1 2 2v3a2 2 0 0 1 -2 2h-3a2 2 0 0 1 -2 -2z" />
    </Icon>
  )
}
...
export function IconRegister(props: IconProps) {
  return (
    <Icon {...props}>
      ...
      <path d="M14 17l-5 -5l5 -5" />
      <path d="M20 12h-11" />
    </Icon>
  )
}

export function IconForgotPassword(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 3c-4.97 0 -9 4.03 -9 9s4.03 9 9 9s9 -4.03 9 -9s-4.03 -9 -9 -9z" />
      <path d="M12 8v4" />
      <path d="M12 16h.01" />
    </Icon>
  )
...
export function IconBiometrics(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 22c5.523 0 10 -4.477 10 -10c0 -5.523 -4.477 -10 -10 -10c-5.523 0 -10 4.477 -10 10c0 5.523 4.477 10 10 10z" />
      <path d="M12 6c-2.21 0 -4 3.582 -4 8s1.79 8 4 8s4 -3.582 4 -8s-1.79 -8 -4 -8z" />
      <path d="M12 2c-5.523 0 -10 8.954 -10 20c0 11.046 4.477 20 10 20c5.523 0 10 -8.954 10 -20c0 -11.046 -4.477 -20 -10 -20z" />
    </Icon>
  )
}
...
export function IconLogout(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M9 21h-4a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h4" />
...
export function IconVerifyEmail(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M22 11.08v.02" />
      <path d="M20.24 4.93l.01 .01" />
      <path d="M16.24 2.5l.01 .01" />
      <path d="M12 2v.01" />
      <path d="M7.76 2.51l.01 .01" />
      <path d="M3.76 4.93l.01 .01" />
      <path d="M2 11.09v.02" />
      <path d="M3.76 17.25l.01 .01" />
      <path d="M7.76 19.68l.01 .01" />
      <path d="M12 20v.01" />
      <path d="M16.24 19.49l.01 .01" />
      <path d="M20.24 17.07l.01 .01" />
      <path d="M9 12l2 2l4 -4" />
    </Icon>
  )
}
...
export function IconFingerPrint(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 11c0 -7 4 -9 4 -9" />
      <path d="M8 4c0 7 -4 9 -4 9" />
      <path d="M16 5c0 6 0 10 -4 13" />
      <path d="M8 13c0 6 0 10 4 13" />
      <path d="M12 22c4 0 8 -4 8 -10c0 -8 -4 -10 -8 -10c-4 0 -8 2 -8 10c0 6 4 10 8 10z" />
      <path d="M12 11c0 -4 0 -6 -2 -8" />
      <path d="M10 3c-2 2 -2 4 -2 8" />
      <path d="M14 11c0 -4 0 -6 2 -8" />
      <path d="M16 3c2 2 2 4 2 8" />
    </Icon>
  )
}
...
export function IconVenues(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M12 21c4.418 0 8 -3.582 8 -8c0 -4.418 -3.582 -8 -8 -8c-4.418 0 -8 3.582 -8 8c0 4.418 3.582 8 8 8z" />
...
export function IconEvents(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M4 5m0 2a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2z" />
      <path d="M16 3l0 4" />
      <path d="M8 3l0 4" />
      <path d="M4 11l16 0" />
    </Icon>
